...
void parcours_instr_si(n_instr *n)
{  
  operande *temporaire, *constante, *etiquette, *etiq_fin;
  temporaire = parcours_exp(n->u.si_.test);
  constante = code3a_new_constante(0);
  etiquette = code3a_new_etiquette("sinon");
  code3a_ajoute_instruction(jump_if_equal, temporaire, constante, etiquette, NULL);
  parcours_instr(n->u.si_.alors);
  etiq_fin = code3a_new_etiquette("fin_si");
  code3a_ajoute_instruction(jump, etiq_fin, NULL, NULL, NULL);
  if(n->u.si_.sinon){
    code3a_ajoute_etiquette("sinon");
    parcours_instr(n->u.si_.sinon);
  }
  code3a_ajoute_etiquette("fin_si");
}
...
{
  operande* boucle;
  boucle = code3a_new_etiquette("tant_que");
  code3a_ajoute_etiquette("tant_que");
  ...
  operande* etiq_fin;
  etiq_fin = code3a_new_etiquette("fin");
...
operande* parcours_opExp(n_exp *n)
{
  ...
  operande* etiquette;
  etiquette = code3a_new_etiquette("vrai");
  ...
  test = code3a_new_etiquette("test");
